...
router.post('/api/usuario',authAdmin,validator,controller.createUsuario);
router.delete('/api/usuario/:id',authAdmin,controller.deleteUsuario);
router.put('/api/usuario/:id',authAdmin,validator,controller.updateUsuario);
